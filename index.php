	...
	<p>Elige una parte del cuerpo la cual deseas entrenar, al hacer click en una parte del cuerpo esto te llevara a una sesion de entrenamientos basados en esa parte del cuerpo</p>
		<div class="svg">
			...
			<g id="Back-Muscles">
					...
					<a href = "#" xlink:title = "Gluteo">
						<path id="Left_Glute" d="M404.4,312.3c2.8-0.5,47.1,21.6,49.5,55.8c2.4,34.1-24.1,46.4-46.5,40.4c-22.4-6-20.7-32.7-20.1-39.1c0.4-4.6,4.4-14.9,8-39.8C396,325.2,401.6,312.8,404.4,312.3L404.4,312.3z"/>
						<path id="Right_Glute" d="M512.8,316.5c-2.5-1-47.2,12.3-55.6,45.3c-8.3,33,13.9,50.1,35.6,48.5c21.7-1.6,24.9-28.1,25.5-34.5c0.4-4.6-1.4-15.4-0.3-40.6C518.2,330.8,515.3,317.5,512.8,316.5L512.8,316.5z"/>
					</a>
					<a href = "#" xlink:title = "Femoral">
					...
					<a href = "#" xlink:title = "Lumbar">
						<path id="Lower_Back" d="M427.5,317.3c0,0-3.7-39.5,27-47.4c0,0,30-3.4,29.4,47.4c0,0-10.7,5.4-28.2,27.8C455.6,345.1,445.2,328.9,427.5,317.3z"/>
					</a>
			</g>
			<!--FIN MUSCULOS PARTE DE LA ESPALDA-->
			<!--MUSCULOS PARTE FRONTAL-->
			<g id="Front-Muscles">
				<a href = "#" xlink:title = "Hombros">
				...
				<a href = "#" xlink:title = "Abductor Posterior">
				...
				<a href = "#" xlink:title = "Abductor Interno">
